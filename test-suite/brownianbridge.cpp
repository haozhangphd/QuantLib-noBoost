...
TEST_CASE( "BrownianBridge_Variates", "[BrownianBridge]" ) {
    ...
    times.emplace_back(0.2);
    times.emplace_back(0.3);
    times.emplace_back(0.4);
    times.emplace_back(0.5);
    times.emplace_back(0.6);
    times.emplace_back(0.7);
    times.emplace_back(0.8);
    times.emplace_back(0.9);
    times.emplace_back(1.0);
    times.emplace_back(2.0);
    times.emplace_back(5.0);
    ...
    if (maxMeanError > meanTolerance) {
        ...
        FAIL_CHECK("failed to reproduce expected mean values"
    ...
    if (maxCovError > covTolerance) {
        FAIL_CHECK("failed to reproduce expected covariance\n"
                    << "    calculated:\n" << covariance
                    << "    expected:\n" << expectedCovariance
...
TEST_CASE( "BrownianBridge_PathGeneration", "[BrownianBridge]" ) {
    ...
    times.emplace_back(2.0);
    times.emplace_back(5.0);
    times.emplace_back(7.0);
    times.emplace_back(9.0);
    times.emplace_back(10.0);
