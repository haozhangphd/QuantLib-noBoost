...
TEST_CASE("ConvertibleBond_Bond", "[ConvertibleBond]") {
    ...
    if (error > tolerance) {
        FAIL_CHECK("failed to reproduce zero-coupon bond price:"
    ...
    if (error > tolerance) {
        FAIL_CHECK("failed to reproduce fixed-coupon bond price:"
    ...
    if (error > tolerance) {
        FAIL_CHECK("failed to reproduce floating-rate bond price:"
...
TEST_CASE("ConvertibleBond_Option", "[ConvertibleBond]") {
    ...
    if (error > tolerance) {
        FAIL_CHECK("failed to reproduce plain-option price:"
                    << "\n    calculated: " << euZero.NPV()
                    << "\n    expected:   " << expected
                    << "\n    error:      " << error
                    << "\n    tolerance:      " << tolerance);
