...
namespace {
    ...
    struct CommonVars {
        ...
        CommonVars() {
            ...
            for (Size i = 0; i < 8; ++i) {
                dates.emplace_back(calendar.advance(today,ts[i],Days));
...
TEST_CASE("PiecewiseZeroSpreadedTermStructure_FlatInterpolationLeft", "[PiecewiseZeroSpreadedTermStructure]") {
    ...
    spreads.emplace_back(Handle<Quote>(spread1));
    spreads.emplace_back(Handle<Quote>(spread2));

    std::vector<Date> spreadDates;
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 8,  Months));
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 15, Months));
...
TEST_CASE("PiecewiseZeroSpreadedTermStructure_LinearInterpolationMultipleSpreads", "[PiecewiseZeroSpreadedTermStructure]") {
    ...
    spreads.emplace_back(Handle<Quote>(spread1));
    spreads.emplace_back(Handle<Quote>(spread2));
    spreads.emplace_back(Handle<Quote>(spread3));
    spreads.emplace_back(Handle<Quote>(spread4));

    std::vector<Date> spreadDates;
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 90,  Days));
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 150, Days));
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 30, Months));
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 40, Months));
...
TEST_CASE("PiecewiseZeroSpreadedTermStructure_LinearInterpolation", "[PiecewiseZeroSpreadedTermStructure]") {
    ...
    std::vector<Date> spreadDates;
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 100,  Days));
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 150, Days));
...
TEST_CASE("PiecewiseZeroSpreadedTermStructure_ForwardFlatInterpolation", "[PiecewiseZeroSpreadedTermStructure]") {
    ...
    std::vector<Date> spreadDates;
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 75,  Days));
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 260, Days));
...
TEST_CASE("PiecewiseZeroSpreadedTermStructure_BackwardFlatInterpolation", "[PiecewiseZeroSpreadedTermStructure]") {
    ...
    std::vector<Date> spreadDates;
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 100,  Days));
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 200, Days));
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 300, Days));
...
TEST_CASE("PiecewiseZeroSpreadedTermStructure_DefaultInterpolation", "[PiecewiseZeroSpreadedTermStructure]") {
    ...
    std::vector<Date> spreadDates;
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 75,  Days));
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 160, Days));
...
TEST_CASE("PiecewiseZeroSpreadedTermStructure_SetInterpolationFactory", "[PiecewiseZeroSpreadedTermStructure]") {
    ...
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 8,  Months));
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 15, Months));
    spreadDates.emplace_back(vars.calendar.advance(vars.today, 25, Months));
