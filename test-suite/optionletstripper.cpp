...
struct CommonVars {
        ...
        void setTermStructure() {
            ...
            yieldTermStructure.linkTo(
                std::shared_ptr<FlatForward>(new FlatForward(0,
                                                               calendar,
                                                               flatFwdRate,
                                                               dayCounter)));
        }
        ...
        void setFlatTermVolSurface() {
            ...
            flatTermVolSurface = std::shared_ptr<CapFloorTermVolSurface>(new
        ...
        void setCapFloorTermVolSurface() {
            ...
            capFloorVolSurface = std::shared_ptr<CapFloorTermVolSurface>(new
                CapFloorTermVolSurface(0, calendar, Following,
                                       optionTenors, strikes,
                                       termV, dayCounter));
        }
...
TEST_CASE("OptionletStripper_TermVolatilityStripping1", "[OptionletStripper]") {
    ...
    std::shared_ptr<StrippedOptionletAdapter> strippedOptionletAdapter =
        std::shared_ptr<StrippedOptionletAdapter>(new
            StrippedOptionletAdapter(optionletStripper1));
...
TEST_CASE("OptionletStripper_TermVolatilityStrippingNormalVol", "[OptionletStripper]") {
    ...
    std::shared_ptr< StrippedOptionletAdapter > strippedOptionletAdapter =
        std::shared_ptr< StrippedOptionletAdapter >(
...
TEST_CASE("OptionletStripper_SwitchStrike", "[OptionletStripper]") {
    ...
    RelinkableHandle< YieldTermStructure > yieldTermStructure;
    yieldTermStructure.linkTo(std::shared_ptr< FlatForward >(
