...
TEST_CASE("CommodityUnitOfMeasure_Direct", "[CommodityUnitOfMeasure]") {
    ...
    Quantity calc =
     ...
     if (!close(calc,actual)) {
        FAIL("Wrong result for MB to BBL Conversion: \n"
                   << "    actual:     " << actual << "\n"
                   << "    calculated: " << calc);
    }
     ...
     if (!close(calc,actual)) {
        FAIL("Wrong result for BBL to Gallon Conversion: \n"
                   << "    actual:     " << actual << "\n"
                   << "    calculated: " << calc);
     }
     ...
     if (!close(calc,actual)) {
        FAIL("Wrong result for BBL to Litre Conversion: \n"
                   << "    actual:     " << actual << "\n"
                   << "    calculated: " << calc);
     }
     ...
     if (!close(calc,actual)) {
        FAIL("Wrong result for BBL to KiloLitre Conversion: \n"
                   << "    actual:     " << actual << "\n"
                   << "    calculated: " << calc);
     }
     ...
     if (!close(calc,actual)) {
        FAIL("Wrong result for MB to Gallon Conversion: \n"
                   << "    actual:     " << actual << "\n"
                   << "    calculated: " << calc);
     }
     ...
     if (!close(calc,actual)) {
        FAIL("Wrong result for Gallon to Litre Conversion: \n"
                   << "    actual:     " << actual << "\n"
                   << "    calculated: " << calc);
     }
}
