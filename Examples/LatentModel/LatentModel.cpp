...
int main(int, char *[]) {
    ...
    try {
        ...
        std::shared_ptr < GaussianDefProbLM > lmG =
                std::make_shared<GaussianDefProbLM>(fctrsWeights,
        ...
        std::shared_ptr < TDefProbLM > lmT = std::make_shared<TDefProbLM>(fctrsWeights,
                // LatentModelIntegrationType::GaussianQuadrature,
        ...
        std::shared_ptr < DefaultLossModel > rdlmG(
                std::make_shared<RandomDefaultLM<GaussianCopulaPolicy> >(lmG,
                                                                         std::vector<Real>(), numSimulations, 1.e-6,
                                                                         2863311530));
