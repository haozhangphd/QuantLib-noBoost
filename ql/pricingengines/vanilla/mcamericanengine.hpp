...
namespace QuantLib {
    ...
    */
    ...
    class MCAmericanEngine
      ...
      protected:
        std::shared_ptr<LongstaffSchwartzPathPricer<Path> >
            lsmPathPricer() const;

        Real controlVariateValue() const;
        std::shared_ptr<PricingEngine> controlPricingEngine() const;
        std::shared_ptr<PathPricer<Path> > controlPathPricer() const;
    ...
    class AmericanPathPricer : public EarlyExercisePathPricer<Path>  {
      public:
        AmericanPathPricer(const std::shared_ptr<Payoff>& payoff,
                           Size polynomOrder,
                           LsmBasisSystem::PolynomType polynomType);
        ...
        std::vector<std::function<Real(const Real&)> > basisSystem() const;
      ...
      protected:
        ...
        std::vector<std::function<Real(const Real&)> > v_;
    };
