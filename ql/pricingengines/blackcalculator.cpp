...
namespace QuantLib {
    ...
    : strike_(strike), forward_(forward), stdDev_(stdDev),
      discount_(discount), variance_(stdDev*stdDev) {
        initialize(std::make_shared<PlainVanillaPayoff>(optionType, strike));
    }
    ...
    Real BlackCalculator::delta(Real spot) const {
        ...
        long double DforwardDs = forward_ / spot;

        long double temp = stdDev_*spot;
        long double DalphaDs = DalphaDd1_/temp;
        long double DbetaDs  = DbetaDd2_/temp;
        long double temp2 = DalphaDs * forward_ + alpha_ * DforwardDs
    ...
    Real BlackCalculator::deltaForward() const {
        ...
        long double temp = stdDev_*forward_;
        long double DalphaDforward = DalphaDd1_/temp;
        long double DbetaDforward  = DbetaDd2_/temp;
        long double temp2 = DalphaDforward * forward_ + alpha_
    ...
    Real BlackCalculator::gamma(Real spot) const {
        ...
        long double D2alphaDs2 = - DalphaDs/spot*(1+d1_/stdDev_);
        long double D2betaDs2  = - DbetaDs /spot*(1+d2_/stdDev_);

        long double temp2 = D2alphaDs2 * forward_ + 2.0 * DalphaDs * DforwardDs
    ...
    Real BlackCalculator::gammaForward() const {
        ...
        long double D2alphaDforward2 = - DalphaDforward/forward_*(1+d1_/stdDev_);
        long double D2betaDforward2  = - DbetaDforward /forward_*(1+d2_/stdDev_);

        long double temp2 = D2alphaDforward2 * forward_ + 2.0 * DalphaDforward
    ...
    Real BlackCalculator::vega(Time maturity) const {
        ...
        long double temp = std::log(strike_/forward_)/variance_;
        // actually DalphaDsigma / SQRT(T)
        long double DalphaDsigma = DalphaDd1_*(temp+0.5);
        long double DbetaDsigma  = DbetaDd2_ *(temp-0.5);

        long double temp2 = DalphaDsigma * forward_ + DbetaDsigma * x_;
    ...
    Real BlackCalculator::rho(Time maturity) const {
        ...
        // actually DalphaDr / T
        long double DalphaDr = DalphaDd1_/stdDev_;
        long double DbetaDr  = DbetaDd2_/stdDev_;
        long double temp = DalphaDr * forward_ + alpha_ * forward_ + DbetaDr * x_;
    ...
    Real BlackCalculator::dividendRho(Time maturity) const {
        ...
        // actually DalphaDq / T
        long double DalphaDq = -DalphaDd1_/stdDev_;
        long double DbetaDq  = -DbetaDd2_/stdDev_;

        long double temp = DalphaDq * forward_ - alpha_ * forward_ + DbetaDq * x_;
    ...
    Real BlackCalculator::strikeSensitivity() const {
        ...
        long double temp = stdDev_*strike_;
        long double DalphaDstrike = -DalphaDd1_/temp;
        long double DbetaDstrike  = -DbetaDd2_/temp;
