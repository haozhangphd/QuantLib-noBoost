    ...
    */
    class BlackCalculator {
      ...
      public:
        ...
        BlackCalculator(const BlackCalculator&) = default;
        BlackCalculator(BlackCalculator&&) = default;
        BlackCalculator& operator=(const BlackCalculator&) = default;
        BlackCalculator& operator=(BlackCalculator&&) = default;
      ...
      protected:
        ...
        long double strike_, forward_, stdDev_, discount_, variance_;
        long double d1_, d2_;
        long double alpha_, beta_, DalphaDd1_, DbetaDd2_;
        long double n_d1_, cum_d1_, n_d2_, cum_d2_;
        long double x_, DxDs_, DxDstrike_;
    };
