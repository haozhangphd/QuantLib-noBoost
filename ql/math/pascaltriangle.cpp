...
namespace QuantLib {
    ...
    const std::vector<BigNatural>& PascalTriangle::get(Size order) {
        if (coefficients_.empty()) {
            ...
            coefficients_.emplace_back(std::vector<BigNatural>(1, 1));

            coefficients_.emplace_back(std::vector<BigNatural>(2, 1));
            coefficients_.emplace_back(std::vector<BigNatural>(3, 1));
            coefficients_[2][1] = 2;
            coefficients_.emplace_back(std::vector<BigNatural>(4, 1));
    ...
    void PascalTriangle::nextOrder() {
        ...
        coefficients_.emplace_back(std::vector<BigNatural>(order+1));
