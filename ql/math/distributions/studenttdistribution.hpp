...
namespace QuantLib {
    ...
    */
    ...
    inline long double pdf(const std::student_t_distribution<long double> &dist, long double p) {
        return StudentDistribution(dist.n())(p);
    }
