...
namespace QuantLib {
    ...
    */
    ...
    public:
        NormalDistribution(long double average = 0.0,
    ...
    */
    ...
    public:
        CumulativeNormalDistribution(long double average = 0.0,
                                     long double sigma = 1.0);
    ...
    */
    ...
    public:
        InverseCumulativeNormal(long double average = 0.0,
                                long double sigma = 1.0);
        ...
        */
        static long double standard_value(long double x) {
            long double z;
            ...
            const long double r = (f_(z) - x) * M_SQRT2 * M_SQRTPI * exp(0.5 * z*z);
            //  Halley's method
            z -= r/(1+0.5*z*r);
#endif
    ...
    private:
        ...
        */
        ...
        static const long double a3_;
        static const long double a4_;
        static const long double a5_;
        static const long double a6_;
        static const long double b1_;
        static const long double b2_;
        static const long double b3_;
        static const long double b4_;
        static const long double b5_;
        static const long double c1_;
        static const long double c2_;
        static const long double c3_;
        static const long double c4_;
        static const long double c5_;
        static const long double c6_;
        static const long double d1_;
        static const long double d2_;
        static const long double d3_;
        static const long double d4_;
        static const long double x_low_;
        static const long double x_high_;
    };
    ...
    */
    ...
    public:
        MoroInverseCumulativeNormal(long double average = 0.0,
                                    long double sigma = 1.0);
    ...
    private:
        long double average_, sigma_;
        static const long double a0_;
        static const long double a1_;
        static const long double a2_;
        static const long double a3_;
        static const long double b0_;
        static const long double b1_;
        static const long double b2_;
        static const long double b3_;
        static const long double c0_;
        static const long double c1_;
        static const long double c2_;
        static const long double c3_;
        static const long double c4_;
        static const long double c5_;
        static const long double c6_;
        static const long double c7_;
        static const long double c8_;
    };
    ...
    */
    ...
    public:
        MaddockInverseCumulativeNormal(long double average = 0.0,
                                       long double sigma = 1.0);
    ...
    public:
        MaddockCumulativeNormal(long double average = 0.0,
                                long double sigma = 1.0);
    ...
    inline long double NormalDistribution::operator()(long double x) const {
        long double deltax = x - average_;
        long double exponent = -(deltax * deltax) / denominator_;
    ...
    inline long double CumulativeNormalDistribution::derivative(long double x) const {
        long double xn = (x - average_) / sigma_;
