...
namespace QuantLib {
    ...
    */
    ...
    private:
        ...
        template <typename T>
        using convecit = typename std::vector<T>::const_iterator;
    ...
    public:
        ...
        */
        ...
        using row_iterator = std::vector<Real>::iterator;
        using const_row_iterator = std::vector<Real>::const_iterator;
        using reverse_row_iterator = std::vector<Real>::reverse_iterator;
        using const_reverse_row_iterator = std::vector<Real>::const_reverse_iterator;
        using column_iterator = step_iterator<vecit<Real>>;
        using const_column_iterator = step_iterator<convecit<Real>>;
    ...
    Matrix outerProduct(Iterator1 v1begin, Iterator1 v1end,
    ...
    inline Matrix::Matrix()
        : data_(std::vector<Real>()), rows_(0), columns_(0) {}
    ...
    inline Matrix::const_row_iterator Matrix::row_end(Size i) const {
        ...
        QL_REQUIRE(i < rows_,
            ...
            ": matrix cannot be accessed out of range");
#endif
        return data_.begin() + (columns_*(i + 1));
    }
    ...
    inline Matrix::const_column_iterator
        ...
        QL_REQUIRE(i < columns_,
            ...
            ": matrix cannot be accessed out of range");
#endif
        return const_column_iterator(data_.begin() + i, columns_);
    }
    ...
    inline Matrix::column_iterator Matrix::column_begin(Size i) {
        ...
        QL_REQUIRE(i < columns_,
            ...
            ": matrix cannot be accessed out of range");
#endif
        return column_iterator(data_.begin() + i, columns_);
    }
    ...
    inline Matrix::const_column_iterator
        ...
        QL_REQUIRE(i < columns_,
            ...
            ": matrix cannot be accessed out of range");
#endif
        return const_column_iterator(data_.begin() + i + rows_*columns_, columns_);
    }
    ...
    inline Matrix::column_iterator Matrix::column_end(Size i) {
        ...
        QL_REQUIRE(i < columns_,
            ...
            ": matrix cannot be accessed out of range");
#endif
        return column_iterator(data_.begin() + i + rows_*columns_, columns_);
    }
    ...
    inline Matrix outerProduct(const Array& v1,
        const Array& v2) {
        return outerProduct(v1.begin(), v1.end(), v2.begin(), v2.end());
    }

    template<class Iterator1, class Iterator2>
    inline Matrix outerProduct(Iterator1 v1begin,
        Iterator1 v1end,
        Iterator2 v2begin,
        Iterator2 v2end) {
        ...
        for (Size i = 0; v1begin != v1end; i++, v1begin++)
            std::transform(v2begin, v2end, result.row_begin(i),
                [v1begin](Real r){return r * (*v1begin); });
