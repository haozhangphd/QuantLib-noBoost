...
namespace QuantLib {
    ...
    namespace {
        ...
        Real IrregularImpliedVolHelper::derivative(Volatility x) const {
            ...
            std::map<std::string,std::any>::const_iterator vega_ =
    ...
    IrregularSwaption::IrregularSwaption(const std::shared_ptr<IrregularSwap>& swap,
                                         const std::shared_ptr<Exercise>& exercise,
                                         IrregularSettlement::Type delivery)
    : Option(std::shared_ptr<Payoff>(), exercise), swap_(swap),
