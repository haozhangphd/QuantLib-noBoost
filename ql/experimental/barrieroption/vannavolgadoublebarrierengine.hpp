         ...
         public:
           ...
           virtual void calculate() const {
               ...
               std::shared_ptr<PricingEngine> engineBS =
                   std::make_shared<DoubleBarrierEngine>(stochProcess,
                                                                    series_);
               ...
               strikes.emplace_back(put25Strike);
               vols.emplace_back(put25Vol);
               strikes.emplace_back(atmStrike);
               vols.emplace_back(atmVol_->value());
               strikes.emplace_back(call25Strike);
               vols.emplace_back(call25Vol);
