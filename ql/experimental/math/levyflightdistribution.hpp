...
namespace QuantLib {
    ...
    */
    class LevyFlightDistribution
    {
      public:
	    ...
	    template<class CharT, class Traits>          
            ...
            operator>>(std::basic_istream<CharT,Traits>& is, const param_type& parm) { 
            ...
            */
            ...
            { return this->xm_ == rhs.xm_ && this->alpha_ == rhs.alpha_; }
	...
	template<class CharT, class Traits>                                 
        friend std::basic_ostream<CharT,Traits>&                            
        operator<<(std::basic_ostream<CharT,Traits>& os, const LevyFlightDistribution& ed) {      
            os << ed.xm_ << " " << ed.alpha_;
            return os;                                                      
        }                                                                   
	...
	template<class CharT, class Traits>          
        friend std::basic_istream<CharT,Traits>&    
        operator>>(std::basic_istream<CharT,Traits>& is, const LevyFlightDistribution& ed) { 
        ...
        /*! Returns true iff the two distributions will produce identical
            sequences of values given equal generators.
        */
        bool operator==(const LevyFlightDistribution& rhs) const
	{ return this->xm_ == rhs.xm_ && this->alpha_ == rhs.alpha_; }
