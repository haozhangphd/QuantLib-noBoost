...
namespace QuantLib {
    ...
    */
    ...
    public:
        ...
        virtual ~RiskyBond() {}
        virtual std::vector<std::shared_ptr<CashFlow> > cashflows() const = 0;
        std::vector<std::shared_ptr<CashFlow> > expectedCashflows();
        virtual Real notional(Date date = Date::minDate()) const = 0;
        virtual Date effectiveDate() const = 0;
        virtual Date maturityDate() const = 0;
        virtual std::vector<std::shared_ptr<CashFlow> > interestFlows() const = 0;
        virtual std::vector<std::shared_ptr<CashFlow> > notionalFlows() const = 0;
    ...
    */
    ...
    public:
        ...
        std::vector<std::shared_ptr<CashFlow> > interestFlows() const;
        std::vector<std::shared_ptr<CashFlow> > notionalFlows() const;
    private:
        Schedule schedule_;
        Real rate_;
        ...
        std::vector<std::shared_ptr<CashFlow> > interestLeg_;
        std::vector<std::shared_ptr<CashFlow> > redemptionLeg_;
    };
