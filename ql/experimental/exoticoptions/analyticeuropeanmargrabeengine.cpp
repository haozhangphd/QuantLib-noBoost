...
/*
 Copyright (C) 2010 Master IMAFA - Polytech'Nice Sophia - UniversitГ© de Nice Sophia Antipolis
...
namespace QuantLib {
    ...
    AnalyticEuropeanMargrabeEngine::AnalyticEuropeanMargrabeEngine(
            const std::shared_ptr<GeneralizedBlackScholesProcess>& process1,
            const std::shared_ptr<GeneralizedBlackScholesProcess>& process2,
            Real correlation)
