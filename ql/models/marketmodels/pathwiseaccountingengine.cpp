...
namespace QuantLib {
    ...
    PathwiseAccountingEngine::PathwiseAccountingEngine(const std::shared_ptr<LogNormalFwdRateEuler>& evolver, // method relies heavily on LMM Euler
        const Clone<MarketModelPathwiseMultiProduct>& product,
        const std::shared_ptr<MarketModel>& pseudoRootStructure, // we need pseudo-roots and displacements
        ...
        deflatorAndDerivatives_(pseudoRootStructure_->numberOfRates()+1)
    {
        ...
        for (Size i=0; i<numberProducts_; ++i)
        {
            ...
            V_.emplace_back(VModel);


            totalCashFlowsThisIndex_.emplace_back(modelCashFlowIndex);
        }
        ...
        for (Size j=0; j<cashFlowTimes.size(); ++j)
            discounters_.emplace_back(MarketModelPathwiseDiscounter(cashFlowTimes[j],
            rateTimes));
        ...
        for (Size i=0; i < numberCashFlowTimes_; ++i)
        {
            ...
            cashFlowIndicesThisStep_[index].emplace_back(i);
        }
...

    ...
    PathwiseVegasAccountingEngine::PathwiseVegasAccountingEngine(
        const std::shared_ptr<LogNormalFwdRateEuler>& evolver, // method relies heavily on LMM Euler
        const Clone<MarketModelPathwiseMultiProduct>& product,
        const std::shared_ptr<MarketModel>& pseudoRootStructure, // we need pseudo-roots and displacements
        ...
        deflatorAndDerivatives_(pseudoRootStructure_->numberOfRates()+1)
    {
        ...
        for (Size i =0; i < numberSteps_; ++i)
        {
            ...
            jacobianComputers_.emplace_back(RatePseudoRootJacobian(pseudoRootStructure_->pseudoRoot(i),evolution.firstAliveRate()[i],
                                numeraires_[i],
                                evolution.rateTaus(),
                                vegaBumps[i], pseudoRootStructure_->displacements()));

            jacobiansThisPaths_.emplace_back(Matrix(numberBumps_,pseudoRootStructure_->numberOfRates()));
...

        ...
        deflatorAndDerivatives_(pseudoRootStructure_->numberOfRates()+1)
    {
       ...
       for (Size i =0; i < numberRates_; ++i)
              jacobiansThisPathsModel.emplace_back(Matrix(numberRates_,factors_));



        for (Size i =0; i < numberSteps_; ++i)
        {
              jacobianComputers_.emplace_back(RatePseudoRootJacobianAllElements(pseudoRootStructure_->pseudoRoot(i),evolution.firstAliveRate()[i],
                                numeraires_[i],
                                evolution.rateTaus(),
            ...
            jacobiansThisPaths_.emplace_back(jacobiansThisPathsModel);
        }
