...
namespace QuantLib
{
    ...
    public:
        ...
        virtual const std::vector<std::shared_ptr<PiecewiseConstantVariance> >& interpolatedVariances() const;
        virtual const std::vector<std::shared_ptr<PiecewiseConstantVariance> >& originalVariances() const;
