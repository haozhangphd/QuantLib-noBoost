...
namespace QuantLib {
    ...
    */
    class Vasicek : public OneFactorAffineModel {
      public:
        ...
        virtual std::shared_ptr<ShortRateDynamics> dynamics() const;
    ...
    */
    class Vasicek::Dynamics : public OneFactorModel::ShortRateDynamics {
      public:
        Dynamics(Real a,
                 ...
                 Real sigma,
                 Real r0)
        : ShortRateDynamics(std::make_shared<OrnsteinUhlenbeckProcess>(a, sigma, r0 - b)),
          b_(b) {}
    ...
    Vasicek::dynamics() const {
        return std::make_shared<Dynamics>(a(), b() , sigma(), r0_);
    }
