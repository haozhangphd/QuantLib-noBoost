...
namespace QuantLib {
    ...
    class ConstantParameter : public Parameter {
      ...
      public:
        ...
        : Parameter(
              1,
              std::make_shared<ConstantParameter::Impl>(),
              constraint)
        {}
    ...
    class NullParameter : public Parameter {
      ...
      public:
        ...
        : Parameter(
                  0,
                  std::make_shared<NullParameter::Impl>(),
                  NoConstraint())
        {}
    };
    ...
    */
    class PiecewiseConstantParameter : public Parameter {
      ...
      public:
        ...
        : Parameter(times.size()+1,
                    std::make_shared<PiecewiseConstantParameter::Impl>(times),
                    constraint)
        {}
    };
    ...
    class TermStructureFittingParameter : public Parameter {
      public:
        ...
        : Parameter(
                  0,
                  std::make_shared<NumericalImpl>(term),
                  NoConstraint())
        {}
    };
