...
namespace QuantLib {
    ...
    CPILeg::operator Leg() const {
        ...
        if (n>0) {
            ...
            for (Size i=0; i<n; ++i) {
                ...
                if (detail::get(fixedRates_, i, 1.0) == 0.0) { // fixed coupon
                    leg.emplace_back(std::shared_ptr<CashFlow>
                                  (new FixedRateCoupon
                    ...
                    if (detail::noOption(caps_, floors_, i)) { // just swaplet
                        std::shared_ptr<CPICoupon> coup;

                        coup = std::shared_ptr<CPICoupon>
                        ...
                        std::shared_ptr<CPICouponPricer> pricer
                            (new CPICouponPricer);
        ...
        std::shared_ptr<CashFlow> xnl(new CPICashFlow
