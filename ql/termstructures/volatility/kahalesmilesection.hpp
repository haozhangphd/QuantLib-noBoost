      ...
      public:
        struct cFunction {
            ...
            Real operator()(Real k) {
                ...
                Real d2 = d1 - s_;
                return f_ * CumulativeNormalDistribution()(d1) -
                       k * CumulativeNormalDistribution()(d2) + a_ * k + b_;
            }
            Real f_, s_, a_, b_;
        ...
        struct aHelper {
            ...
            Real operator()(Real a) const {
                Real d20 = InverseCumulativeNormal()(-c0p_ + a);
                Real d21 = InverseCumulativeNormal()( -c1p_ + a);
        ...
        struct sHelper {
            ...
            Real operator()(Real s) const {
                s = std::max(s, 0.0);
                Real d20 = InverseCumulativeNormal()(-c0p_);
        ...
        struct sHelper1 {
            ...
            Real operator()(Real s) const {
                s = std::max(s, 0.0);
                Real d21 = InverseCumulativeNormal()(-c1p_);
