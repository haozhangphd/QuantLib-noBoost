...
OptionletStripper::OptionletStripper(
    ...
    : termVolSurface_(termVolSurface), iborIndex_(iborIndex),
      ...
      volatilityType_(type), displacement_(displacement) {
        ...
        optionletTenors_.emplace_back(indexTenor);
        capFloorLengths_.emplace_back(optionletTenors_.back()+indexTenor);
        ...
        while (nextCapFloorLength<=maxCapFloorTenor) {
            optionletTenors_.emplace_back(capFloorLengths_.back());
            capFloorLengths_.emplace_back(nextCapFloorLength);
