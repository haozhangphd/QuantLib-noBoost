...
namespace QuantLib {
    ...
    //! Minute number
    /*! \ingroup datetime */
    using Minute = Integer;

    //! Second number
    /*! \ingroup datetime */
    using Second = Integer;

    //! Millisecond number
    /*! \ingroup datetime */
    using Millisecond = Integer;

    //! Microsecond number
    /*! \ingroup datetime */
    using Microsecond = Integer;
#endif
    ...
    */
    ...
    class Date {
      public:
...
#ifdef QL_HIGH_RESOLUTION_DATE
        //! Constructor taking std time_point object
        explicit Date(const std::chrono::time_point<std::chrono::system_clock, std::chrono::microseconds>& time);
        //! More traditional constructor.
        Date(Day d, Month m, Year y,
        ...
        const std::chrono::time_point<std::chrono::system_clock, std::chrono::microseconds>& dateTime() const;
#endif
        //@}
      ...
      private:
        ...
        void advance(Integer units, TimeUnit);

#ifdef QL_HIGH_RESOLUTION_DATE
        std::chrono::time_point<std::chrono::system_clock, std::chrono::microseconds> dateTime_;
#else
    ...
    */
    ...
    namespace io {
        ...
        //! output dates in user defined format
        /*! \ingroup manips */
