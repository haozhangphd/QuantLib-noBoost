...
namespace QuantLib {
    ...
    : FloatingRateBond(2, 100.0,
                       ...
                       std::shared_ptr<Euribor6M>(new Euribor6M(fwdCurve)),
                       Actual360(),
                       Following,
    ...
    RendistatoBasket::RendistatoBasket(
            const std::vector<std::shared_ptr<BTP> >& btps,
    ...
    RendistatoCalculator::RendistatoCalculator(
                            const std::shared_ptr<RendistatoBasket>& basket,
                            const std::shared_ptr<Euribor>& euriborIndex,
    ...
    RendistatoEquivalentSwapLengthQuote::RendistatoEquivalentSwapLengthQuote(
        const std::shared_ptr<RendistatoCalculator>& r) : r_(r) {}
