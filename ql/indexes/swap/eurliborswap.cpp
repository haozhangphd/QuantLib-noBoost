...
namespace QuantLib {
    ...
    : SwapIndex("EurLiborSwapIsdaFixA", // familyName
                ...
                tenor > 1*Years ?
                    std::make_shared<EURLibor>(6*Months, h) :
                    std::make_shared<EURLibor>(3*Months, h)) {}
    ...
    : SwapIndex("EurLiborSwapIsdaFixA", // familyName
                ...
                Thirty360(Thirty360::BondBasis), // fixedLegDaycounter
                tenor > 1*Years ?
                    std::make_shared<EURLibor>(6*Months, forwarding) :
                    std::make_shared<EURLibor>(3*Months, forwarding),
                discounting) {}
